 ...
 */
@Slf4j
public class JoAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new JoCustomOAuth2AccessTokenResponseHttpMessageConverter();
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if (MapUtil.isNotEmpty(map)) {
			// 发送异步日志事件
			 JoUser userInfo = (JoUser) map.get(SecurityConstants.DETAILS_USER);
