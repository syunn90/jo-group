...
import com.jo.rpc.comm.annotation.RpcScan;
...
public class RouteScanner {
    ...
    public synchronized void san() {
        if (basePackages.isEmpty()) {
            ...
            if (primarySources.isAnnotationPresent(RpcScan.class)) {
                RpcScan rpcScan = primarySources.getDeclaredAnnotation(RpcScan.class);
