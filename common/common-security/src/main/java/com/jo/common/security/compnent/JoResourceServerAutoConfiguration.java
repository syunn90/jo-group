...
public class JoResourceServerAutoConfiguration {
     ...
     */
    @Bean
    public JoBearerTokenExtractor joBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
        return new JoBearerTokenExtractor(urlProperties);
    }
    ...
    public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
        return new JoCustomOpaqueTokenIntrospector(authorizationService);
    }
    ...
    public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
        return new JoOAuthRequestInterceptor(tokenResolver);
    }
}
